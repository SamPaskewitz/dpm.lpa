...
outcome_analysis_normal = function(model,
                                   ...
                                   facet_var = 'variable',
                                   ncol = 4){
  result = lpa$lpa_outcome_analysis$fit_y_normal(model, y, x_new, y_new, index, profile_labels, do_post_hoc, start_profile_labels_from1, prior_alpha, prior_beta, prior_m, prior_lambda, figure_size, font_size, facet_var, ncol)
